...
export const DellRecordSchema=z.object({
 url:z.string().url().refine(v=>new URL(v).hostname.toLowerCase().endsWith('dell.com'),'Product URL must belong to dell.com'),
...
export type DellRecord=z.infer<typeof DellRecordSchema>;
