...
export function isSamsClubUrl(v:string){try{const u=new URL(v);return u.protocol==='https:'&&(u.hostname==='samsclub.com'||u.hostname.endsWith('.samsclub.com'));}catch{return false;}}
