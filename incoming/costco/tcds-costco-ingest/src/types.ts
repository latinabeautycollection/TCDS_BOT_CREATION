...
export const CostcoRecordSchema=z.object({
  ...
  availability:nullableString, group_id:z.union([z.string(),z.number()]).nullable().optional().transform(v=>v==null?null:String(v)), listing_has_variations:z.boolean().default(false),
...
export type CostcoRecord=z.infer<typeof CostcoRecordSchema>;
