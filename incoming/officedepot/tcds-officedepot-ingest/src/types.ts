...
export const OfficeDepotRecordSchema = z.object({
  url: z.string().url().refine((value) => {
    const host = new URL(value).hostname.toLowerCase();
    return host === 'officedepot.com' || host.endsWith('.officedepot.com');
  }, 'Product URL must belong to officedepot.com'),
...
export type OfficeDepotRecord = z.infer<typeof OfficeDepotRecordSchema>;
