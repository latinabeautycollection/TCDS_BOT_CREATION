...
export function isKohlsUrl(v:string){try{const u=new URL(v);return u.protocol==='https:'&&(u.hostname==='kohls.com'||u.hostname.endsWith('.kohls.com'));}catch{return false;}}
