...
export const KohlsRecordSchema=z.object({
 url:z.string().url().refine(v=>new URL(v).hostname.toLowerCase().endsWith('kohls.com'),'Product URL must belong to kohls.com'),
...
export type KohlsRecord=z.infer<typeof KohlsRecordSchema>;
