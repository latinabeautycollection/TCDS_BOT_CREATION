...
export function isHarborFreightUrl(v:string){try{const u=new URL(v);return u.protocol==='https:'&&(u.hostname==='harborfreight.com'||u.hostname.endsWith('.harborfreight.com'));}catch{return false;}}
