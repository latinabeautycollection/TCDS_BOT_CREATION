...
export const CDWRecordSchema=z.object({
 url:z.string().url().refine(v=>new URL(v).hostname.toLowerCase().endsWith('cdw.com'),'Product URL must belong to cdw.com'),
...
export type CDWRecord=z.infer<typeof CDWRecordSchema>;
