...
export function isCrutchfieldUrl(v:string){try{const u=new URL(v);return u.protocol==='https:'&&(u.hostname==='crutchfield.com'||u.hostname.endsWith('.crutchfield.com'));}catch{return false;}}
